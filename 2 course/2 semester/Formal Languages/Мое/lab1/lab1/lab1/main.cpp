...
void preparingDFA(State states[])
{
	states[0].state = 1;
	states[0].newState = { 2 };
	states[0].transitionSymbols = {'a'};

	states[1].state = 2;
	states[1].newState = { 3 };
	states[1].transitionSymbols = { 'a' };

	states[2].state = 3;
	states[2].newState = { 4, 5, 6 };
	states[2].transitionSymbols = { 'a', 'b', 'c' };

	states[3].state = 4;
	states[3].newState = { 4, 5, 6 };
	states[3].transitionSymbols = { 'a', 'b', 'c' };

	states[4].state = 5;
	states[4].newState = { 4, 5, 6 };
	states[4].transitionSymbols = { 'a', 'b', 'c' };

	states[5].state = 6;
	states[5].newState = { 4, 5, 6 };
	states[5].transitionSymbols = { 'a', 'b', 'c' };
}
